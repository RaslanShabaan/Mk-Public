...
public class Security_Config extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/GoRegister","/Register","/Login","/Check","/GoPostt","/GOAllUsers","/IUser","/IAdmin","/er").permitAll()
               // enable Styles  
                .antMatchers("/css/**","/scss/**","/js/**","/img/**","/images/**","/webapp/WEB-INF/images/","/WEB-INF/images/","/webapp/images/").permitAll()
