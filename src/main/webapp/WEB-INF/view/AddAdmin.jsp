...
<div class="wrapper">
    ...
    <h3 style="font-style: italic;font-weight: bold;color: red"> ${Add}</h3>
    
    <h2>Add New Admin </h2>
    <form action="/AddAdmin" method="Post">
<input  required="required" name="UN" style="margin-left: 50px;border-radius: 10%" placeholder="Admin-Name" />
<br><br>
<input name="PS" required="required"  style="margin-left: 50px;border-radius: 10%" type="password" placeholder="Admin-PassWord" />
<br>
<input type="hidden"   name="${_csrf.parameterName}"	value="${_csrf.token}"/>
<br>
<button class="btn" style="margin-left: 70px"> Add New Admin</button>
</form>
