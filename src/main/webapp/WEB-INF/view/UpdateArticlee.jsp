...
<div class="wrapper">
    ...
    String ff =(String) sesson.getAttribute("S");
 %>
<form action="/Update" method="Post"  enctype="multipart/form-data">
    <input type="hidden"  name="Ad" value= <%= ff %> /> 
    <input type="text" required="required" placeholder="Article-Header" name="Head"/>
                                                <br><br>
<textarea style="width: 400px;height: 200px;color:#000;" name="Update" ></textarea>
 <br>
  <input type="file" name="file" placeholder="Article-Picture" required="required"/><br />
                               
 <input type="hidden"name="${_csrf.parameterName}"value="${_csrf.token}"/>
<button style="color:green;border-color:green" class="btn"> Update Article </button>
</form>
