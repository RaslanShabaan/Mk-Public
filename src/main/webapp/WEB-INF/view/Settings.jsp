...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <h3  style="font-style: italic;font-weight: bold;color: red"> ${Sett}</h3>
    <h2>Account Settings </h2>
    <form action="/IAdminn" method="Post">
<input name="UN" style="margin-left: 50px;border-radius: 10%" placeholder="Admin-New-Name" required="required"/>
<br><br>
<input name="PS"   style="margin-left: 50px;border-radius: 10%" type="password" placeholder="Admin-New-PassWord" required="required"/>
<br>
<input type="hidden"   name="${_csrf.parameterName}"	value="${_csrf.token}"/>
<br>
<button class="btn" style="margin-left: 70px"> Update Data</button>
</form>
