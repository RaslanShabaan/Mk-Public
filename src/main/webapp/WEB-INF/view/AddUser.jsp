...
<div class="wrapper">
    ...
    <h3 style="font-style: italic;font-weight: bold;color: red"> ${AUser}</h3>
    
    <h2>Add New User </h2>
    <form action="/AddUser" method="Post">
<input  required="required" name="UN" style="margin-left: 50px;border-radius: 10%" placeholder="User-Name" />
<br><br>
<input name="PS" required="required"  style="margin-left: 50px;border-radius: 10%" type="password" placeholder="User-PassWord" />
<br>
<input type="hidden"   name="${_csrf.parameterName}"	value="${_csrf.token}"/>
<br>
<button class="btn" style="margin-left: 70px"> Add New User</button>
</form>
