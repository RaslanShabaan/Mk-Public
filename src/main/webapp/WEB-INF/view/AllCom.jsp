...
<%
    ...
    ArrayList fx =(ArrayList) sess.getAttribute("allart");
    
%>

					<div class="gtco-accordion">
						<h2> Head Article Is : <span style="font-style: italic;font-weight: bold;font-size: 25px;color:#c7254e;"><%= fx.get(0) %> </span></h1>
						<h3> Article Is : <span style="font-style: italic;font-weight: bold;font-size: 25px;color:#c7254e;"><%= fx.get(1) %></span></h1>
						<img src="/images/<%= fx.get(2) %>  " style="width: 500px;height: 300px"/>
						<h3> --------------------- Comments are : --------------------- </h1>
				
<%
    HttpSession sesson=request.getSession();
    ArrayList ff =(ArrayList) sesson.getAttribute("allcom");
    int size=ff.size()/2;
    int plus=0;
...
<%
    ...
    %>
				...
				<h3> User Name Is : <span style="font-style: italic;font-weight: bold;font-size: 25px;color:#c7254e;"> <%= ff.get(plus) %> </span></h1>
				<h4> comment is  : <span style="font-style: italic;font-weight: bold;font-size: 25px;color:#c7254e;"> <%= ff.get(plus+1) %>  </span></h4>
